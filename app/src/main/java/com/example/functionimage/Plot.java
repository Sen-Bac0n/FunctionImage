...
public class Plot {
    ...
    public void draw(Canvas canvas)
    {
        ...
        Expre e = new Expre();
        double oldx = m_nMinX;
        String postfix = e.toSuffix(m_strExp);
        double oldy  = Double.parseDouble(e.dealEquation(postfix,m_nMinX));
        ...
        for (int i = 1; i < 100; i++)
        {
            ...
            double newy = Double.parseDouble(e.dealEquation(postfix,newx));
